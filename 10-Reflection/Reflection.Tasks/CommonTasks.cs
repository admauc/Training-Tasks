...
namespace Reflection.Tasks
{
    public static class CommonTasks
    {
        ...
        public static IEnumerable<string> GetPublicObsoleteClasses(string assemblyName)
        {
            ...
            return assembly.GetTypes().Where(x => x.IsClass && x.GetCustomAttributes(typeof(ObsoleteAttribute), true).Any()).Select(x => x.Name);
        }
        ...
        /// obj.GetType().BaseType.GetProperty(properties.Last()).SetValue(obj, value, null);
